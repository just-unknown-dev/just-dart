...
We as members, contributors, and maintainers of **Just Dart** pledge to make participation in our community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, caste, colour, religion, or sexual identity and orientation.
...
- If needed, open a public issue in [the repository issue tracker](https://github.com/just-unknown-dev/just-dart/issues) with minimal details and request private follow-up.
